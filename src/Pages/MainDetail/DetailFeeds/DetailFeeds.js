...
import "./DetailFeeds.scss";
import ShareModal from "../../Main/shareModal/ShareModal";
// import "~slick-carousel/slick/slick.css";
// import "~slick-carousel/slick/slick-theme.css";
import Slider from "react-slick";

class DetailFeeds extends Component {
  state = {
    comments: [
      {
        id: 0,
  ...
  appKeyPress = (e) => {
    ...
    if (e.key === "Enter") {
      this.addReple();
      //아래 내용이 댓글창 내용 초기화
      document.getElementsByClassName("footerReplyInput")[0].value = "";
    }
  };

  // addReple = () => {
  //   console.log(document.getElementsByClassName("footerReplyInput"));
  //   const newComment = document.getElementsByClassName("footerReplyInput")[0].value;
  //   console.log(newComment);
  //   //alert(newComment);

  //   if (newComment.length !== 0) {
  //     const commentsArr = this.state.feeds;
  //     commentsArr.push({
