  ...
  render() {
    return (
      <section className="DetailPageContents">
        <h3>노랑 노랑 옐로 옐로 쿠션</h3>
        <article>
          때로는 시원하게, 때로는 따뜻하게.
          <br />
          컨디션에 맞게 사용하는 노랑 노랑 옐로 옐로 쿠션입니다.
          <br />
          노랑 노랑 옐로 옐로 색감이 주는 귀여움은 덤이랍니다.
        </article>
        <hr className="thickHr" />
        <img
          src="https://images.unsplash.com/photo-1579592608994-5d8154ade1c2?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1534&q=80https://images.unsplash.com/photo-1601276174812-63280a55656e?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80"
