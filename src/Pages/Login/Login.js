...
//               <input type="checkbox" id="c2" checked="true" />
//               <label for="c2">
//                 <span></span>만 14세 이상입니다.(필수)
//               </label>
//             </li>
//             <li className="checkboxes">
//               <input type="checkbox" id="c3" checked="true" />
//               <label for="c3">
//                 <span></span>이용약관(필수)
//               </label>
//             </li>
//             <li className="checkboxes">
//               <input type="checkbox" id="c4" checked="true" />
//               <label for="c4">
//                 <span></span>개인정보처리방침(필수)
//               </label>
//             </li>
//             <li className="checkboxes">
//               <input type="checkbox" id="c5" checked="true" />
//               <label for="c5">
